...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER 28.00
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -29.30
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -7.67
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 62,160} // X,Y,Z Axis Extend and Retract angles
